...
/* colors */
static const char norm_fg[]     = "#7ac3c8";   // cyan
static const char norm_bg[]     = "#050909";   // very dark background
static const char norm_border[] = "#55888c";   // muted cyan border

static const char sel_fg[]      = "#7ac3c8";   // cyan
static const char sel_bg[]      = "#0E3A46";   // deep teal
static const char sel_border[]  = "#7ac3c8";   // cyan border

static const char hid_fg[]      = "#7ac3c8";   // cyan
static const char hid_bg[]      = "#0F748B";   // vibrant teal
static const char hid_border[]  = "#7ac3c8";   // cyan border

static const unsigned int baralpha    = 0xCC; // semi-transparent
static const unsigned int borderalpha = 0xEE; // nearly opaque
